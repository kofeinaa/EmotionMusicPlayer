...
public class StorageUtil {
    ...
    private final String STORAGE = "com.wigdis.playerr.STORAGE";
    ...
    public void storeMood(Mood mood) {
    ...
    public Mood loadMood() {
        preferences = context.getSharedPreferences(STORAGE, Context.MODE_PRIVATE);
        Gson gson = new Gson();
        String json = preferences.getString("mood", null);
        Type type = new TypeToken<Mood>() {}.getType();
